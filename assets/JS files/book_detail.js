...
img_1.setAttribute("src", res["bookImage"]);
// img_1.setAttribute('alt', res["Image"]["alt"]);
...
p_tag.innerText = res["book_description"];
...
author_img.setAttribute("src", res["author_image"]);
...
P_tag2.innerHTML = res["author_content"];
...
span_tag.innerHTML = res["publisher_date"];
...
span_tag_2.innerHTML = res["book_binding"];
...
span_tag_3.innerHTML = res["Book_height"];
...
span_tag_4.innerHTML = res["Book_pages"] + " Pages";
...
span_tag_5.innerHTML = res["Book_series_title"];
...
span_tag_6.innerHTML = res["Book_weight"];
...
span_tag_7.innerHTML = res["imprint"];
...
span_tag_8.innerHTML = res["Book_depth"];
...
span_tag_9.innerHTML = res["Book_language"];
...
span_tag_10.innerHTML = res['return'];
...
span_tag_11.innerHTML = res["spin_width"];
...
span_tag_12.innerHTML = res["width"];
