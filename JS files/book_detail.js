...
// Create a div 
    ...
    img_1.setAttribute("src", product_details[0]["Image"]["source"]);
    img_1.setAttribute('alt', product_details[0]["Image"]["alt"]);
    ...
    h1.innerText = product_details[0]["title"];

    // Create a h4 tag / json real pirce
    const h4 = document.createElement("h4");
    h4.innerText = product_details[0]["Price"];

    // Create a Small tag / json offer price
    const small = document.createElement("s");
    small.innerText = product_details[0]["offer_price"];
    h4.append(small);
    ...
    p_tag.innerText = product_details[0]["book_summary"];
    ...
    author_img.setAttribute("src", product_details[0]["Author_img"]["source"]);
    author_img.setAttribute("alt", product_details[0]["Author_img"]["alt"]);
    ...
    P_tag2.innerHTML = product_details[0]["About_author"];
    ...
    span_tag.innerHTML = product_details[0]["publiser_Date"];
    ...
    span_tag_2.innerHTML = product_details[0]["Binding"];
    ...
    span_tag_3.innerHTML = product_details[0]["Height"];
    ...
    span_tag_4.innerHTML = product_details[0]["No of pages"];
    ...
    span_tag_5.innerHTML = product_details[0]["Series of title"];
    ...
    span_tag_6.innerHTML = product_details[0]["weight"];
    ...
    span_tag_7.innerHTML = product_details[0]["Publiser_imprint"];
    ...
    span_tag_8.innerHTML = product_details[0]["Depth"];
    ...
    span_tag_9.innerHTML = product_details[0]["Language"];
    ...
    span_tag_10.innerHTML = product_details[0]['Returable'];
    ...
    span_tag_11.innerHTML = product_details[0]["Spin_width"];
    ...
    span_tag_12.innerHTML = product_details[0]["width"];
